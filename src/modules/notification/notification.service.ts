    ...
    public async saveNotification(
        ...
        const notificationRecord = await this.db.notification.create({data:notificationData})
    ...
    public async sendNotificationBasedOnStatus(notificationData:Notification[]): Promise<void> {
      ...
      public async updateNotificationStatus(error:any,notificationData:any):Promise<void>{
